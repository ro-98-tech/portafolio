...
# Portafolio — Roberto Carlos Meléndez Mayén

Desarrollador **Java Full Stack Jr**. Construyo aplicaciones web funcionales, claras y con buen diseño, usando Java, Spring Boot, MySQL y herramientas del ecosistema web moderno.
...
- **Íconos**: Bootstrap Icons (CDN) + Devicon (CDN)
